...
functions = {'ASN1_BIT_STRING_check': Function(type='int', derefcnt=0, name='ASN1_BIT_STRING_check', args=[Argument(type='ASN1_BIT_STRING', derefcnt=1, name='a'), Argument(type='unsigned', derefcnt=1, name='flags'), Argument(type='int', derefcnt=0, name='flags_len')]),
 ...
 'sysctl': Function(type='int', derefcnt=0, name='sysctl', args=[Argument(type='int', derefcnt=1, name='name'), Argument(type='int', derefcnt=0, name='nlen'), Argument(type='void', derefcnt=1, name='oldval'), Argument(type='size_t', derefcnt=1, name='oldlenp'), Argument(type='void', derefcnt=1, name='newval'), Argument(type='size_t', derefcnt=0, name='newlen')]),
