...
functions = {'ASN1_BIT_STRING_check': Function(type='int', derefcnt=0, name='ASN1_BIT_STRING_check', args=[Argument(type='ASN1_BIT_STRING', derefcnt=1, name='a'), Argument(type='unsigned', derefcnt=1, name='flags'), Argument(type='int', derefcnt=0, name='flags_len')]),
 ...
 'compress': Function(type='int', derefcnt=0, name='compress', args=[Argument(type='COMP_CTX', derefcnt=1, name='ctx'), Argument(type='unsigned', derefcnt=1, name='out'), Argument(type='unsigned', derefcnt=0, name='olen'), Argument(type='unsigned', derefcnt=1, name='in'), Argument(type='unsigned', derefcnt=0, name='ilen')]),
